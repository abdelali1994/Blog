                ...
                foreach ($affiche->fetchAll() as $key => $article) : ?>
                    ...
                    <div class="card col-lg-3 p-0 shadow  mx-3 my-4" >
                        ...
                        <div class="card-body ">
                            ...
                            <a type="button" href="Article.php?id_article=<?php echo $id ?>" class="btn btn-success  ">read more</a>

                        </div>
                    </div> -->

                    <!-- <div class="card" style="width: 18rem;"> -->
                        <img src="Article/<?php echo  $article['image'] ?>" class="card-img-top" style="width: 100%;height:200px" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo  $article['title'] ?></h5>
                            <p class="card-text"><?php echo  substr($article['contenu'], 0, 200) . '................' ?></p>
                            <a type="button" href="Article.php?id_article=<?php echo $id ?>" class="btn btn-success  ">read more</a>
                        </div>
                    </div>
                <?php endforeach;
