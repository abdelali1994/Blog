...
html,body{
background-image: url('Login-image/retrosupply-jLwVAUtLOAQ-unsplash.jpg');
			...
			<div class="card-body">
				<form method="POST" action="register.php" enctype="multipart/form-data">
					<div class="input-group form-group">
						...
						<input type="text" id="name" class="form-control" required name="name" placeholder="Name" value="<?= (isset($_POST['name'])) ? $_POST['name'] : '' ?>">
