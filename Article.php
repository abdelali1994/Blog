...
<div   style="width: 90%;height: 500px;  margin-left: auto;
    margin-right: auto; " >
         <img src="Article/<?php echo  $image ?>"  alt="" style="width: 100%;  height: auto;
" >
     </div>   
...
<div class="card col-lg-8 p-0 shadow  mx-3 my-4" >
     <div>
         <img src="Article/<?php echo  $image ?>" class="card-img-top p-4 img-thumbnail " alt="" style="width: 60%;" >
     </div>   
      <div class="row " style="margin:10px 0 0 10px;">
      <!-- <i class="far fa-user-circle far1"></i>  -->
      <div>
      <a href='article_auteur.php?id_auteur=<?php echo $id_auteur?>'><img src="Avatar/<?php echo  $avatar ?>"  alt="" style=" width:70px" class="rounded-circle" >
</a>


      </div>
      <h5 style="margin:10px 0 0 10px;">   BY:<a href='article_auteur.php?id_auteur=<?php echo $id_auteur?>'><?php echo  $fullname ?></a></h5></div>
...
?>
    ...
    <hr>      
       ...
       <input type="hidden"  name="id_article" value="<?php echo $_GET["id_article"]?>"/>
                   ...
                   <button type="submit" class="btn btn-primary" name="submit3" onclick="validate()" >Valider</button>
               </form>
